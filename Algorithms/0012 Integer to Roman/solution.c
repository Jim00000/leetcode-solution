...
__attribute__((always_inline)) inline static int __divide_remainder(const int dividend, const int divisor, int *remainder)
{
    int quotient;
    __asm__ volatile(
        /* instructions */
...
const int roman_num[] = {1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1000};
const char *roman_symbols[] = {"I", "IV", "V", "IX", "X", "XL", "L", "XC", "C", "CD", "D", "CM", "M"};
const int roman_symbols_size[] = {1, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1};
